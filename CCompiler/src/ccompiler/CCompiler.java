...
/*****************************************************************/
/*****************************************************************/
  final public Node compilation_unit() throws ParseException, CompileException {utils.tree.Node root;
    Node node;
    node = stmts();
    jj_consume_token(0);
root=new Node("root").addChildren(node);
  ...
  final public Node stmts() throws ParseException, CompileException {Node node=new Node("stmts");
    Node tmp;
    label_1:
    while (true) {
...
{if ("" != null) return node.simplify();}
  ...
  final public Node stmt() throws ParseException, CompileException {Node node=null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SEMIC:{
...
if(node!=null){
  ...
  final public Node block() throws ParseException, CompileException {Node node;
...
SymbolTable.popSymbolTable();
  ...
  final public Node def_stmt() throws ParseException, CompileException {Node node;
...
// only for main
  final public Node def_fun() throws ParseException, CompileException {Node node;
    Node t,id,b;
    t = type();
    id = name();
...
// only for main
  final public Node return_stmt() throws ParseException, CompileException {Node node=new Node("return");
    Node val;
...
{if ("" != null) return node;}
  ...
  final public Node type() throws ParseException, CompileException {Node node;
    node = typedef_base();
{if ("" != null) return node;}
    throw new Error("Missing return statement in function");
}

  final public Node typedef_base() throws ParseException, CompileException {Token x;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VOID:{
...
{if ("" != null) return new Node("type").setAttribute(Node.Type,x.image);}
    throw new Error("Missing return statement in function");
}

  final public Node name() throws ParseException, CompileException {Token id;
...
{if ("" != null) return new Node(Node.Symbol)
  ...
  final public Node def_vars() throws ParseException, CompileException {Node node=new Node("defVars");
    Node t,id,val;
    Node temp;
    t = type();
    id = name();
...
// TODO may not used
  final public Node number() throws ParseException, CompileException {Node node=new Node("terminal");
    Token x;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INT_VALUE:{
...
{if ("" != null) return node.setAttribute(Node.Value,x.image);}
  ...
  final public Node terminal() throws ParseException, CompileException {Node node=new Node("terminal");
    Token x;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INT_VALUE:{
      x = jj_consume_token(INT_VALUE);
...
{if ("" != null) return node.setAttribute(Node.Value,Node.TerminalValue+x.image);}
    throw new Error("Missing return statement in function");
}

  final public Node assigns_stmt() throws ParseException, CompileException {Node node=new Node("assigns");
    Node id;
    Node val;
    id = name();
    jj_consume_token(ASSIGN);
...
{if ("" != null) return node.simplify();}
  ...
  final public Node expr() throws ParseException, CompileException {Node lnode,rnode;
    Node op_node=null;
    Token op;
    lnode = expr1();
    label_4:
...
if(op_node==null){
  ...
  final public Node expr1() throws ParseException, CompileException {Node lnode,rnode;
    Node op_node=null;
    Token op;
    lnode = expr2();
    label_5:
...
if(op_node==null){
  ...
  final public Node expr2() throws ParseException, CompileException {Node lnode,rnode;
    Node op_node=null;
    Token op;
    lnode = expr3();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
if(op_node==null){
  ...
  final public Node expr3() throws ParseException, CompileException {Node lnode,rnode;
    Node op_node=null;
    Token op;
    lnode = expr4();
    label_6:
...
if(op_node==null){
  ...
  final public Node expr4() throws ParseException, CompileException {Node lnode,rnode;
    Node op_node=null;
    Token op=null;
    lnode = pre_op_const();
    label_7:
...
if(op_node==null){
  ...
  final public Node pre_op_const() throws ParseException, CompileException {Node node;
    Token op=null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PLUS:{
      op = jj_consume_token(PLUS);
...
String temp=FourTermStyle.newTemp();
  ...
  final public Node pre_op() throws ParseException, CompileException {Node node;
    Token op=null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INC:{
...
FourTermStyle style=FourTermStyle.addCurrent(
  ...
  final public Node post_op() throws ParseException, CompileException {Node node;
    Token op=null;
...
{if ("" != null) return node;}
  ...
  final public Node term() throws ParseException, CompileException {Node node;
    Node temp;
...
{if ("" != null) return SymbolTable.getNode_r(node);}
  ...
  final public Node if_stmt() throws ParseException, CompileException {Node cond;
    Node if_node;
    Node else_node=null;
...
//        only first effective backpatch make sense, following is empty if,else case
  ...
  final public Node while_stmt() throws ParseException, CompileException {Node cond;
    Node while_node;
...
//        only first effective backpatch make sense, following is empty while case
        ...
        {if ("" != null) return new Node("while").addChildren(cond,while_node);}
    throw new Error("Missing return statement in function");
}

  final public Node dowhile_stmt() throws ParseException, CompileException {Node cond;
    Node dowhile_node;
    jj_consume_token(DO);
...
cond.typeMatch("bool");
        ...
        {if ("" != null) return new Node("dowhile").addChildren(dowhile_node,cond);}
    throw new Error("Missing return statement in function");
}

  final public Node for_stmt() throws ParseException, CompileException {Node for_0=new Node("null");
...
jmp.backpatchResult(for_node.getAttribute(Node.StyleId));
        {if ("" != null) return new Node("for").addChildren(for_0,for_1,for_2,for_node);}
    throw new Error("Missing return statement in function");
}
  ...
  private boolean jj_3R_29()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x1c72400,0x400,0x10000,0x0,0x0,0x10400,0x1c62000,0x0,0x1000,0x800,0x1000,0x0,0x0,0x800,0x10000000,0x8000000,0xe6000000,0xe6000000,0x60000,0x60000,0x380000,0x380000,0x1c62000,0xc02000,0xc00000,0x2000,0x2000,0x1c72400,0x1c72400,0x0,0x1c72400,0x1c72400,0x400,0x1c62000,0x1c62000,0x1c72400,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x1087fff6,0x0,0xee2,0x3114,0xee2,0x0,0x1087c000,0xee2,0x0,0x0,0x0,0x38000,0x10878000,0x0,0x0,0x0,0x1,0x1,0x0,0x0,0x0,0x0,0x1087c000,0x1087c000,0x0,0x1087c000,0x1087c000,0x1087fff6,0x1087fff6,0x8,0x1087fff6,0x1087fff6,0x4ee2,0x1087c000,0x1087c000,0x1087fff6,};
	}
